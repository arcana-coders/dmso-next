  ...
  try {
    ...
    if (process.env.RESEND_API_KEY) {
      ...
      await resend.emails.send({
        ...
        to: [email],
        subject: '¡Bienvenido a DMSO México!',
        text: `¡Hola!\n\nGracias por suscribirte a DMSO México. Serás el primero en saber sobre nuevos productos y promociones.\n\nVisítanos en: https://www.dmso.com.mx\n\n— Equipo DMSO México`,
